...
class CourseViewHolder(view: View): RecyclerView.ViewHolder(view) {
    ...
    private val courseTitle : TextView = view.findViewById(R.id.tv_course)
    private val courseTime : TextView = view.findViewById(R.id.tv_time)
    private val courseLecturer : TextView = view.findViewById(R.id.tv_lecturer)
